<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Home Partner</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Edit Home Partner</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h3 class="card-title">Edit Home Partner</h3>
                        </div>

                        <form action="<?= base_url('partners/update/' . $page['partnerId']) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($page['logo'])): ?>
                                        <img src="<?= $page['logo'] ?>" alt="Image" class="mt-2 img-thumbnail" width="150">
                                    <?php endif; ?>
                                </div>
