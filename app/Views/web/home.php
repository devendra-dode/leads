      ...
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            src="<?= base_url() ?>assets/web/theme/images/banner/banner.png"
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="section-title pt-4">
          ...
          <p>From personal loans to business funding, we make financing simple and hassle-free</p>
        </div>
      </div>
<?php 
...
<?php if (!empty($filteredServices)): ?>
    <?php foreach ($filteredServices as $index => $service): ?>
        <div class="col-lg-4 col-md-6 service-item">
            <a class="text-black" href="service-details.html">
                <div class="block"> 
                    <span class="colored-box text-center h3 mb-4">0<?= $index + 1 ?></span>
                    <h3 class="mb-3 service-title">
                        <i class="<?= esc($service['icon']) ?>"></i> 
                        <?= esc($service['name']) ?>
                    </h3>
                    <p class="mb-0 service-description"><?= esc($service['short_description']) ?></p>
                </div>
            </a>
        </div>
    <?php endforeach; ?>
...
<section id="aboutUs" class="about-section section bg-tertiary position-relative overflow-hidden">
  <div class="container">
      ...
      <div class="col-lg-5">
        <div class="section-title">
          ...
          <p class="lead mb-0 mt-4">
            <p>We are committed to providing quick, hassle-free financial solutions tailored to your needs. With a seamless process and flexible payment options, we ensure your journey to financial freedom is smooth and stress-free.</p>
            ✅ Instant Approvals | ✅ Low-Interest Rates | ✅ Customer-Centric Approach
            <p class="mt-1">Let us help you achieve your financial goals with ease and confidence!</p>
          </p> <a class="btn btn-primary mt-4" href="<?= base_url() ?>about-us">Know About Us</a>
        </div>
      </div>
      <div class="col-lg-7 text-center text-lg-end">
        <img loading="lazy" decoding="async" src="<?= base_url() ?>assets/web/theme/images/about-us.png" alt="About Ourselves" class="img-fluid">
      </div>
    </div>
  </div>
  <div class="has-shapes">
...
<section class="section loan-steps bg-tertiary" id="howitWorks">
	<div class="container">
        ...
        <div class="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async"
                    src="<?= base_url() ?>assets/web/theme/images/payment-info.png" alt="How Much Can I Recive?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
          <div class="tab-pane fade " id="pills-how-much-does-it-costs" role="tabpanel"
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async" src="<?= base_url() ?>assets/web/theme/images/illustration-2.png" alt="How Much Does It Costs?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
          <div class="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async" src="<?= base_url() ?>assets/web/theme/images/illustration-1.png" alt="How Do I Repay?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
...
<section class="section testimonials overflow-hidden bg-tertiary" id="testimonials">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <div class="section-title text-center">
    ...
    <div class="row position-relative">
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="<?= base_url() ?>assets/web/theme/images/testimonials/01.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="<?= base_url() ?>assets/web/theme/images/testimonials/02.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="<?= base_url() ?>assets/web/theme/images/testimonials/03.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="<?= base_url() ?>assets/web/theme/images/testimonials/04.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="<?= base_url() ?>assets/web/theme/images/testimonials/05.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="<?= base_url() ?>assets/web/theme/images/testimonials/06.jpg"
